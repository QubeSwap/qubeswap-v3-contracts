...
async function main() {
  ...
  const v3PeripheryDeployedContracts = await import(`@qubeswap/v3-periphery/deployments/${networkName}.json`)

  const qubeV3PoolDeployer_address = v3DeployedContracts.QubeV3PoolDeployer
