...
describe('QubeV3Pool', () => {
  ...
  let pool0: MockTimeQubeV3Pool
  let pool1: MockTimeQubeV3Pool
  ...
  let swapTargetCallee: TestQubeV3Callee
  let swapTargetRouter: TestQubeV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeQubeV3Pool, any]> => {
