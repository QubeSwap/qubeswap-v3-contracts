...
import '@qubeswap/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@qubeswap/v3-core/contracts/libraries/SafeCast.sol';
import '@qubeswap/v3-core/contracts/libraries/TickMath.sol';
import '@qubeswap/v3-core/contracts/libraries/TickBitmap.sol';
...
import '@qubeswap/v3-periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IQubeV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    /// @inheritdoc IQubeV3SwapCallback
    function qubeV3SwapCallback(
        ...
        IQubeV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IQubeV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
