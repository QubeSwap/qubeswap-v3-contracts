...
```solidity
constructor(contract IMasterChefV2 _v2, contract IMasterChefV3 _v3, contract IERC20 _qst, uint256 _v2Pid) public
```
...
| _qst | contract IERC20 | Qst token address. |
...
Withdraw unexpected tokens sent to the receiver, can also withdraw qst.
