...
const QubeStableSwapFactory = artifacts.require("stable-swap/contracts/QubeStableSwapFactory.sol");
const QubeStableSwapLPFactory = artifacts.require("stable-swap/contracts/QubeStableSwapLPFactory.sol");
const QubeStableSwapTwoPoolDeployer = artifacts.require("stable-swap/contracts/QubeStableSwapTwoPoolDeployer.sol");
const QubeStableSwapThreePoolDeployer = artifacts.require("stable-swap/contracts/QubeStableSwapThreePoolDeployer.sol");
const QubeStableSwapTwoPool = artifacts.require("stable-swap/contracts/QubeStableSwapTwoPool.sol");
const QubeStableSwapThreePool = artifacts.require("stable-swap/contracts/QubeStableSwapThreePool.sol");
const QubeStableSwapTwoPoolInfo = artifacts.require("stable-swap/contracts/utils/QubeStableSwapTwoPoolInfo.sol");
const QubeStableSwapThreePoolInfo = artifacts.require("stable-swap/contracts/utils/QubeStableSwapThreePoolInfo.sol");
const QubeStableSwapInfo = artifacts.require("stable-swap/contracts/utils/QubeStableSwapInfo.sol");
const LPToken = artifacts.require("stable-swap/contracts/QubeStableSwapLP.sol");
...
const QubeFactory = artifacts.require("exchange-protocol/contracts/QubeFactory.sol");
const QubePair = artifacts.require("exchange-protocol/contracts/QubePair.sol");
const QubeRouter = artifacts.require("exchange-protocol/contracts/QubeRouter.sol");
...
contract("SmartRouter", ([admin, bob, carol]) => {
    ...
    before(async () => {
        ...
        /** Create Stable Swap */
        stableSwapLPFactory = await QubeStableSwapLPFactory.new({ from: admin });
        stableSwap2PoolDeployer = await QubeStableSwapTwoPoolDeployer.new({ from: admin });
        stableSwap3PoolDeployer = await QubeStableSwapThreePoolDeployer.new({ from: admin });
        stableSwapFactory = await QubeStableSwapFactory.new(stableSwapLPFactory.address, stableSwap2PoolDeployer.address, stableSwap3PoolDeployer.address, {
            from: admin,
        });
        stableSwap2PoolInfo = await QubeStableSwapTwoPoolInfo.new({ from: admin });
        stableSwap3PoolInfo = await QubeStableSwapThreePoolInfo.new({ from: admin });
        stableSwapPoolInfo = await QubeStableSwapInfo.new(stableSwap2PoolInfo.address, stableSwap3PoolInfo.address, { from: admin });
        ...
        stable2Pool_BUSD_USDC = await QubeStableSwapTwoPool.at(stable2PoolInfo.swapContract);
        ...
        stable2Pool_WBNB_BUSD = await QubeStableSwapTwoPool.at(stable2PoolInfo_WBNB_BUSD.swapContract);
        ...
        stable3Pool_BUSD_USDC_USDT = await QubeStableSwapThreePool.at(stable3PoolInfo.swapContract);
