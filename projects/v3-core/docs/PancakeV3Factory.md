...
Deploys QubeSwap V3 pools and manages ownership and control over pool protocol fees
...
```solidity
mapping(uint24 => struct IQubeV3Factory.TickSpacingExtraInfo) feeAmountTickSpacingExtraInfo
```
