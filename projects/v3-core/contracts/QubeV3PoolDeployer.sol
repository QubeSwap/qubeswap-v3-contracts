...
import './QubeV3Pool.sol';

contract QubeV3PoolDeployer is IQubeV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc IQubeV3PoolDeployer
    ...
    /// @param factory The contract address of the QubeSwap V3 factory
    ...
    function deploy(
        ...
        pool = address(new QubeV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
