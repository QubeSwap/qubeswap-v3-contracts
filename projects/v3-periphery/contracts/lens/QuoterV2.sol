...
contract QuoterV2 is IQuoterV2, IQubeV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IQubeV3Pool) {
        return IQubeV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function qubeV3SwapCallback(
        ...
        IQubeV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IQubeV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
