...
import '@qubeswap/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
library SmartRouterHelper {
    ...
    // bytes32 internal constant V2_INIT_CODE_HASH = 0xd0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66; // BSC
    bytes32 internal constant V2_INIT_CODE_HASH = 0x7c27b87ce7e5020dc232eb18955710518facd8229e0e24ce58cf56850347c937;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0xff8cf767c489eacae3c8dfa347e214264f959dd5704d279952d9b6128b051f3e;
    ...
    /// @param deployer The QubeSwap V3 deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (IQubeV3Pool) {
        return IQubeV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid QubeSwap V3 Pool
    /// @param deployer The contract address of the QubeSwap V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IQubeV3Pool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (IQubeV3Pool pool)
    {
        pool = IQubeV3Pool(computeAddress(deployer, poolKey));
