...
await $`yarn workspace @qubeswap/v3-core run hardhat run scripts/deploy.ts --network ${network}`

await $`yarn workspace @qubeswap/v3-periphery run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @qubeswap/smart-router run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @qubeswap/masterchef-v3 run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @qubeswap/v3-lm-pool run hardhat run scripts/deploy2.ts --network ${network}`
