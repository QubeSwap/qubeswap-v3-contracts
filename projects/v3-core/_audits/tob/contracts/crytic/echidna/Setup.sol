...
import '../../../../../contracts/QubeV3Pool.sol';
import '../../../../../contracts/QubesV3Factory.sol';
...
contract SetupUniswap {
    ...
    QubesV3Factory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new QubesV3Factory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = QubeV3Pool(factory.createPool(address(token0), address(token1), _fee));
...
contract UniswapMinter {
    ...
    function setPool(QubeV3Pool _pool) public {
        pool = _pool;
    }
