...
import '@qubeswap/v3-core/contracts/libraries/FixedPoint128.sol';
import '@qubeswap/v3-core/contracts/interfaces/IQubeV3Pool.sol';

import './libraries/LmTick.sol';

import './interfaces/IQubeV3LmPool.sol';
import './interfaces/IMasterChefV3.sol';
import './interfaces/IQubeV3LmPoolDeveloper.sol';

contract QubeV3LmPool is IQubeV3LmPool {
  ...
  IQubeV3Pool public immutable pool;
  ...
  constructor() {
    (address poolAddress, address masterChefAddress) = IQubeV3LmPoolDeveloper(msg.sender).parameters();
    pool = IQubeV3Pool(poolAddress);
